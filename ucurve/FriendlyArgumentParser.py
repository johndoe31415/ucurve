...
def biunits_baseint(value, default_base = 10):
	if value.endswith("k"):
		return baseint(value[:-1], default_base) * 1024
	elif value.endswith("M"):
		return baseint(value[:-1], default_base) * 1024 * 1024
	elif value.endswith("G"):
		return baseint(value[:-1], default_base) * 1024 * 1024 * 1024
	else:
		return baseint(value, default_base)
